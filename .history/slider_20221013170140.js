...
const img1 = document.querySelector(".header__slider--item-1");

const btnSlider2 = document.querySelector(".button-slider-2");
const img2 = document.querySelector(".header__slider--item-2");

const btnSlider3 = document.querySelector(".button-slider-3");
const img3 = document.querySelector(".header__slider--item-3");
