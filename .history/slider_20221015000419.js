...
btnNext.onclick = ()=>{
  ...
  gridItem[2].style.marginLeft = "-1000%"
  gridItem[3].style.marginLeft = "-1000%"
  gridItem[4].style.marginLeft = "-1000%"
  gridItem[5].style.marginLeft = "-1000%";
  gridItem[6].style.marginLeft = "-1000%"
  gridItem[7].style.marginLeft = "-1000%"
  gridItem[8].style.marginLeft = "-1000%"
  gridItem[9].style.marginLeft = "-1000%"
}