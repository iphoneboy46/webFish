...
btnNext.onclick = ()=>{
 ...
 console.log(imgFish);
 document.querySelector(".section__content--grid ").appendChild(imgFish[9])
 document.querySelector(".section__content--grid ").appendChild(imgFish[10])
 document.querySelector(".section__content--grid ").appendChild(imgFish[11])
 ...
 document.querySelector(".section__content--grid ").appendChild(imgFish[15])
}
