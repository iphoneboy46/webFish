...
function menuMobile() {
  ...
  const menuChildrenMobi = document.querySelector(".menu--children-mobile");
  const menuChildrenMobi2 = document.querySelector(".menu--children-mobile-children");
  const dropdownMobileChildren = document.querySelector(".dropdown-mobile-children2");
 
    dropdownMobile.onclick = () => {
      menuChildrenMobi.classList.toggle("active-menuChildren")
    };

    dropdownMobileChildren.onclick = () => {
      menuChildrenMobi2.classList.toggle("active-menuChildren-children")
    };
