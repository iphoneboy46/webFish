...
btnNext.onclick = ()=>{
  gridItem[0].style.marginLeft = "-300%";
  gridItem[1].style.marginLeft = "-300%"
  gridItem[2].style.marginLeft = "-300%"
  gridItem[3].style.marginLeft = "-300%"
  gridItem[4].style.marginLeft = "-300%"
  gridItem[5].style.marginLeft = "-300%";
  gridItem[6].style.marginLeft = "-300%"
  gridItem[7].style.marginLeft = "-300%"
  gridItem[8].style.marginLeft = "-300%"
  gridItem[9].style.marginLeft = "-300%"
  gridItem[10].style.marginLeft = "-300%"
  gridItem[11].style.marginLeft = "-300%"
  gridItem[12].style.marginLeft = "-300%"
}