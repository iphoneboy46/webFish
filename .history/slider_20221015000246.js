...
btnNext.onclick = ()=>{
  gridItem[0].style.marginLeft = "-100%";
  gridItem[1].style.marginLeft = "-50%"
  gridItem[2].style.marginLeft = "-50%"
  gridItem[3].style.marginLeft = "-50%"
  gridItem[4].style.marginLeft = "-50%"
  gridItem[5].style.marginLeft = "-50%";
  gridItem[6].style.marginLeft = "-50%"
  gridItem[7].style.marginLeft = "-50%"
  gridItem[8].style.marginLeft = "-50%"
  gridItem[9].style.marginLeft = "-50%"
}